...
export default function HomePage() {
  ...
  const handleAPKDownload = () => {
    ...
    link.href = '/downloads/socrates.apk'; // Update this path to your APK file location
    link.download = 'socrates.apk';
    link.target = '_blank';
    
    // Fallback for mobile browsers
    if (navigator.userAgent.toLowerCase().indexOf('android') > -1) {
      // For Android devices, open the download directly
      window.open('/downloads/socrates.apk', '_blank');
    } else {
  ...
  return (
    <Layout>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {featuredCourses && featuredCourses.length > 0 && (
            <div className="text-center mt-12">
              <Link
                to="/courses"
                className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-500 via-orange-600 to-blue-500 hover:from-blue-600 hover:via-orange-700 hover:to-blue-600 text-white font-semibold rounded-xl text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
              >
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 via-orange-50 to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900" dir="rtl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden relative">
                    ...
                    <div className="p-6 space-y-6">
                      ...
                      <div className="flex items-center space-x-4" dir="rtl">
                        ...
                        <div>
                          <h3 className="font-bold text-lg text-gray-900">تطبيق سنتر سقراط</h3>
                      ...
                      <div className="space-y-4">
                        <div className="bg-gradient-to-r from-blue-50 to-blue-50 rounded-xl p-4">
                          <div className="flex justify-between items-start mb-2">
                            <h4 className="font-semibold text-gray-900">سنتر سقراط</h4>
                            <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">جديد</span>
                          </div>
                          <p className="text-sm text-gray-600 mb-3"> سنتر سقراط </p>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-center p-4 bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div>
                  ...
                  <a href="https://wa.me/+201145446621" className="text-green-600 dark:text-green-400 hover:underline">
                  +201145446621
                  </a>
                </div>
              </div>
            ...
            <div className="mt-12 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 max-w-md mx-auto">
                <a
                  href="https://www.facebook.com/share/1BhVkJSTdS/"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/socrates_center?igsh=MTgwbWs1YmtsaHgzcA=="
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:text-blue-600 hover:scale-105"
                  title="Instagram"
