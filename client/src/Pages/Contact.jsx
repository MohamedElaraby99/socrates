...
export default function Contact() {
  ...
  const socialMedia = [
    { name: "Facebook", icon: FaFacebook, url: "https://www.facebook.com/share/1BhVkJSTdS/", color: "hover:text-blue-600" },
    { name: "Instagram", icon: FaInstagram, url: "https://www.instagram.com/socrates_center?igsh=MTgwbWs1YmtsaHgzcA==", color: "hover:text-purple-600" },
